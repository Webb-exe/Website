...
<div bind:this={container} class="fixed inset-0 -z-10" id="robot-bg">
  <img bind:this={heroRobot} src="/2e8c74a1-f585-4be5-a641-f0a44a202559.PNG" alt="359 Robot" class="hero-robot w-full h-full object-cover object-center origin-center" />
  <!-- Dynamic overlay that changes with scroll -->
  <div bind:this={bgOverlay} class="absolute inset-0 bg-dark pointer-events-none" style="opacity: 0;"></div>
  <!-- Vignette -->
